...
import org.eclipse.andmore.android.model.java.BroadcastReceiverClass;
...
public class Receiver extends Launcher {
     ...
     * 
     * @return True if the broadcast receiver class was successfully created and
    ...
    private boolean createReceiverClass(IProgressMonitor monitor) throws AndroidException {
        ...
        BroadcastReceiverClass receiverClass = new BroadcastReceiverClass(getName(),
            ...
            if (applicationNode != null) {
                ...
                if (!receiverExists) {
                    ...
                    if (receiverLabel != null) {
                        receiverNode.setLabel(AndroidProjectResources.STRING_CALL_PREFIX + receiverLabel);
                    }
    ...
    private String createReceiverLabel(IProgressMonitor monitor) throws AndroidException {
        ...
        if ((getLabel() != null) && (getLabel().trim().length() > 0)) {
            try {
                ...
                resLabel = stringsFile.getNewResourceName(getName() + RECEIVER_RESOURCE_LABEL_SUFFIX);
