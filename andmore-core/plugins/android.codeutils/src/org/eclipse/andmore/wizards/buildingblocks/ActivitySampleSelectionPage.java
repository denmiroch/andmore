...
public class ActivitySampleSelectionPage extends NewLauncherWizardPage {
    ...
    public IWizardPage getNextPage() {
        ...
        if ((selection != null)
                && selection.equalsIgnoreCase(ActivityBasedOnTemplate.LIST_ACTIVITIES_SAMPLE_LOCALIZED)) {
            return getWizard().getPage(NewActivityWizardListTemplatesPage.PAGE_NAME);
        }
        return getWizard().getPage(CodeUtilsNLS.UI_NewActivityMainPage_PageTitle);
    }
