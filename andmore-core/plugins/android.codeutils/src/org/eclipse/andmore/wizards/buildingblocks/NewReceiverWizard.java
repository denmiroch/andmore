...
public class NewReceiverWizard extends NewBuildingBlocksWizard {
    ...
    public boolean performFinish() {
        ...
        if (saved) {
            ICompilationUnit javaFile = getBuildingBlock().getPackageFragment()
                    .getCompilationUnit(getBuildingBlock().getName() + ".java");
            ...
            if ((javaFile != null) && javaFile.exists()) {
                try {
                    ...
                    // Do nothing
                    AndmoreLogger.error(NewReceiverWizard.class,
                            "Could not open the broadcast receiver " + getBuildingBlock().getName() + " on an editor.",
                            e);
        ...
        if (saved) {
            ...
            try {
                AndmoreLogger.collectUsageData(UsageDataConstants.WHAT_BUILDINGBLOCK_RECEIVER,
