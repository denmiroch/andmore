        ...
        try {
            ...
            if (syncService != null) {
                ...
                if (OPEN_ACTION.equals(actionValue)) {
                    ...
                    try {
                        promptAndPull(syncService, client.getClientData().getClientDescription() + HPROF_FILE_EXTENSION,
                                remoteFilePath, AndroidNLS.AndmoreHProfDumpHandler_saveHProfFile);
                    } catch (Exception e) {
                        displayErrorFromUiThread(
                                AndroidNLS.UI_Hprof_Handler_Dialog_Unable_to_download_Hprof + FORMATTED_ERROR_STRING,
        ...
        Display.getCurrent().syncExec(new Runnable() {
            ...
            public void run() {
                ...
                if (openPrefPage) {
                    ...
                    EclipseUtils.openPreference(ww.getShell(), "org.eclipe.andmore.ddms.preferences.PreferencePage"); //$NON-NLS-1$
                }
            }
        });
    }
