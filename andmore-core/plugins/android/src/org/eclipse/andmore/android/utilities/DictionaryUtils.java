...
public class DictionaryUtils {
    ...
    public static void createOrUpdateDictionaryFile(IProject project, List<StringNode> strings,
        ...
        IFile projectStringXmlFile = project
                .getFile(IAndroidConstants.RES_DIR + IAndroidConstants.VALUES_DIR + IAndroidConstants.STRINGS_FILE);

        LocalizationFile locFile = null;

        if (projectStringXmlFile.exists()) {

            ProjectLocalizationManager projManager = LocalizationManager.getInstance()
