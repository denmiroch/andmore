        ...
        SelectionListener location_listener = new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                if (isNewProject ^ existentProject ^ fromSample) {
                    ...
                    project.setSourceType(isNewProject ? SourceTypes.NEW
                            : existentProject ? SourceTypes.EXISTING : SourceTypes.SAMPLE);
