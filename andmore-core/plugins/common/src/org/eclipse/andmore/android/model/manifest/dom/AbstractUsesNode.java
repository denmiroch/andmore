 ...
 * "name"
 */
public abstract class AbstractUsesNode extends AndroidManifestNode implements IAndroidManifestProperties {
    static {
    ...
    private boolean isRequired = true; // it is true by default, need to be
                                       // declared explicitly to false
