...
public class PaletteMetadataDescriptor extends ViewElementDescriptor {
    ...
    public PaletteMetadataDescriptor(ViewElementDescriptor descriptor, String displayName, String initString,
            String iconName) {
        super(descriptor.getXmlName(), displayName, descriptor.getFullClassName(), descriptor.getTooltip(),
                descriptor.getSdkUrl(), descriptor.getAttributes(), descriptor.getLayoutAttributes(),
