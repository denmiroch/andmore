...
public class UseCompoundDrawableAction extends VisualRefactoringAction {
    ...
    public void run(IAction action) {
        if ((mTextSelection != null || mTreeSelection != null) && mFile != null) {
            UseCompoundDrawableRefactoring ref = new UseCompoundDrawableRefactoring(mFile, mDelegate, mTextSelection,
                    mTreeSelection);
    ...
    public static IAction create(LayoutEditorDelegate editorDelegate) {
        return create("Convert to a Compound Drawable...", editorDelegate, UseCompoundDrawableAction.class);
    }
}
