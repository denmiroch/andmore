...
public class AvdCompatibility {
     ...
     */
    public static Compatibility canRun(AvdInfo avd, IAndroidTarget projectTarget, AndroidVersion minApiVersion) {
        if (avd == null) {
        ...
        if (projectTarget.isPlatform()) {
            return avdTarget.getVersion().canRun(minApiVersion) ? Compatibility.YES : Compatibility.NO;
        }
